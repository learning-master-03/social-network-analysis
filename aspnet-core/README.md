...
```bash
dotnet dev-certs https -v -ep openiddict.pfx -p ec3577b9-7a46-45ad-91b7-f3e2e1942fb9
```

> `ec3577b9-7a46-45ad-91b7-f3e2e1942fb9` is the password of the certificate, you can change it to any password you want.
