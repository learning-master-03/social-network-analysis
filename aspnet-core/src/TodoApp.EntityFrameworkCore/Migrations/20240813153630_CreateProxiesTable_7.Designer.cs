...
namespace TodoApp.Migrations
{
    ...
    [Migration("20240813153630_CreateProxiesTable_7")]
    partial class CreateProxiesTable_7
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("Acme.BookStore.Books.PuppeteerConfiguration", b =>
                {
                    b.Property<Guid>("Id")
                        .HasColumnType("uniqueidentifier");
                    ...
                    b.Property<bool>("IgnoreDefaultArgs")
                        .HasColumnType("bit");

                    b.Property<bool>("IgnoreHTTPSErrors")
                        .HasColumnType("bit");

                    b.Property<string>("IgnoredDefaultArgs")
                        .IsRequired()
                        .HasColumnType("nvarchar(max)");
                    ...
                    b.ToTable("PuppeteerConfigurations", (string)null);
                });

            modelBuilder.Entity("TodoApp.Proxies", b =>
                {
                    b.Property<Guid>("Id")
                        .HasColumnType("uniqueidentifier");
            ...
            modelBuilder.Entity("TodoApp.ProxyJobs", b =>
                {
                    b.Property<Guid>("Id")
                        .HasColumnType("uniqueidentifier");
                    ...
                    b.ToTable("ProxyJobs", (string)null);
                });

            modelBuilder.Entity("TodoApp.TikiCategory", b =>
                {
                    b.Property<Guid>("Id")
                        .HasColumnType("uniqueidentifier");
                    ...
                    b.ToTable("TikiCategories", (string)null);
                });

            modelBuilder.Entity("TodoApp.TikiProduct", b =>
                {
                    b.Property<Guid>("Id")
                        .HasColumnType("uniqueidentifier");
            ...
            modelBuilder.Entity("TodoApp.TikiProductImage", b =>
                {
                    b.Property<Guid>("Id")
                        .HasColumnType("uniqueidentifier");
            ...
            modelBuilder.Entity("TodoApp.TikiReview", b =>
                {
                    ...
                    b.Property<string>("RatingAttribute")
                        .HasColumnType("nvarchar(max)");
                    ...
                    b.ToTable("TikiReviews", (string)null);
                });
            ...
            modelBuilder.Entity("TodoApp.TikiProductImage", b =>
                {
                    b.HasOne("TodoApp.TikiProduct", "tikiProduct")
                        .WithMany("TikiProductImages")
                        .HasForeignKey("tikiProductId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();

                    b.Navigation("tikiProduct");
                });

            modelBuilder.Entity("TodoApp.TikiProductLink", b =>
                {
                    b.HasOne("TodoApp.TikiCategory", null)
                        .WithMany("tikiProductLinks")
            ...
            modelBuilder.Entity("TodoApp.TikiCategory", b =>
                {
                    b.Navigation("tikiProductLinks");
                });

            modelBuilder.Entity("TodoApp.TikiProduct", b =>
                {
                    b.Navigation("TikiProductImages");

                    b.Navigation("TikiReviews");
                });
